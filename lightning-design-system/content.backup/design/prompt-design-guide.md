...
description: "As tools like Agentforce and Einstein power more of your workflows, clear prompts are critical. They don’t just improve results—they make your AI more sustainable, too."
category: "design"
...
![](https://www.lightningdesignsystem.com/uploads/hNFPDK2YyLZu8lHWDer-rA.png)

## Introduction

As tools like Agentforce and Einstein power more of your workflows, clear prompts are critical. They don’t just improve results—they make your AI more [sustainable](https://www.salesforce.com/en-us/wp-content/uploads/sites/4/documents/company/sustainability/salesforce-ai-sustainability-outlook.pdf), too.
...
<table style="min-width: 502px;"><colgroup><col style="width: 157px;"><col style="width: 320px;"><col></colgroup><tbody><tr><td colspan="1" rowspan="1" colwidth="157">**Feature**</td><td colspan="1" rowspan="1" colwidth="320">**Prompt Template**</td><td colspan="1" rowspan="1" colwidth="null">**Agent**</td></tr><tr><td colspan="1" rowspan="1" colwidth="157">**Scope**</td><td colspan="1" rowspan="1" colwidth="320">A single, specific taskExample: summarize a case</td><td colspan="1" rowspan="1" colwidth="null">A broader, multi-step goalExample: resolve a customer issue</td></tr><tr><td colspan="1" rowspan="1" colwidth="157">**Interaction**</td><td colspan="1" rowspan="1" colwidth="320">One-way instruction for a single action</td><td colspan="1" rowspan="1" colwidth="null">Conversational multi-turn dialogues</td></tr><tr><td colspan="1" rowspan="1" colwidth="157">**Capability**</td><td colspan="1" rowspan="1" colwidth="320">Executes pre-defined text instructions</td><td colspan="1" rowspan="1" colwidth="null">Orchestrates multiple tools and actions</td></tr><tr><td colspan="1" rowspan="1" colwidth="157">**Intelligence**</td><td colspan="1" rowspan="1" colwidth="320">Contained within the quality of the prompt</td><td colspan="1" rowspan="1" colwidth="null">Understands intent, makes decisions, and takes action</td></tr><tr><td colspan="1" rowspan="1" colwidth="157">**Analogy**</td><td colspan="1" rowspan="1" colwidth="320">A specialized toolExample: email generation</td><td colspan="1" rowspan="1" colwidth="null">An intelligent workerExample: a personal assistant</td></tr></tbody></table>
...
Rooted in conversation design, this guide offers principles and best practices for novice to intermediate Salesforce users to create accurate, enterprise-grade prompts using Salesforce tools like [Prompt Builder](https://www.salesforce.com/artificial-intelligence/prompt-builder/) and [Agent Builder](https://www.salesforce.com/agentforce/agent-builder/). It covers the overall prompt design process and the essential parts of a good prompt, including its core structure, elements, and key patterns.
...
This guide empowers individuals within the Salesforce ecosystem who have prompt creation and editing permissions to design impactful, enterprise-grade AI interactions. It focuses on information for novice- to intermediate-level enterprise prompt design. Developers seeking more advanced technical tactics and implementation details should refer to [Salesforce Help](https://help.salesforce.com/s) for additional resources.
