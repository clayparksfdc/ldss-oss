...
extractedAt: "2026-02-21T16:55:01.134Z"
---
...
In VS Code, add the following code to your settings.json file (Cmd+Shift+P → Open User Settings (JSON)).JSON     "agentic.mcp.servers": {
        "figma": {
...
            "args": ["agentforce", "mcp", "start"]

        }

    },

    "agentic.server.mcp.enabled": true,

    "agentic.server.mcp.port":3443
...
To allow Agentforce Vibes to auto-deploy metadata to your sandbox, click Auto-Approve.Note: You can configure Agentforce Vibes to run approved terminal commands automatically. To do so, configure Agentforce Vibes safe commands.
