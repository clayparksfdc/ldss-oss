...
- [**Semantically-named colors:**](https://www.lightningdesignsystem.com/2e1ef8501/p/655b28-color/b/25b51f) Used for building components and UI page elements such as backgrounds, borders, and fills. Use these colors only for their respective locations. For example, --slds-g-color-border-1is meant for borders, strokes, or divider lines. Don’t use this color for the background of a container.
