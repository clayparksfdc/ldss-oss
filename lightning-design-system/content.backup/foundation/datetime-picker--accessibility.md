...
description: "Hover States: When a user hovers over the input field or dropdown, the cursor changes to cursor: text to indicate interactivity."
category: "foundation"
...
- All datetime fields marked as required with an * must have an accompanying legend.**Example:** * denotes a required field
