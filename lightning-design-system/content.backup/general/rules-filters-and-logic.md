...
When users **are not **adding their own rules and **cannot** change the logic mode, use components such as combobox, dual listbox, select, and text input. These simple and familiar elements will give users fast access to their desired results.
