---
title: "Canvas"
description: "The canvas is the main working area of a builder layout, and occupies the bulk of UX real estate. Here users can add and manipulate components, nodes and connectors, or data elements."
category: "general"
slug: "canvas"
status: "published"
...
| The canvas is the main working area of a builder layout, and occupies the bulk of UX real estate. Here users can add and manipulate components, nodes and connectors, or data elements. * <button type="button" aria-label="Open image lightbox"><i color="#ffffff" size="4" style="margin-right: 0px;"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"></svg>*</button> Builder canvas <input type="file" accept=".jpg, .jpeg, .png, .svg, .gif, .webp" aria-label="File"> | <h3>Start using our Design Kits</h3> [ * ](https://www.figma.com/@salesforce) <button type="button" aria-label="Open image lightbox"><i color="#ffffff" size="4" style="margin-right: 0px;"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"></svg>*</button> <input type="file" accept=".jpg, .jpeg, .png, .svg, .gif, .webp" aria-label="File"> [Open in Figma](https://www.figma.com/community/file/1415890669347272207) |
| --- | --- |
...
*See *[*Nodes*](https://www.lightningdesignsystem.com/2e1ef8501/p/8001a6)* for more information*

#### Connectors

Connectors are lines that connect nodes, representing relationships and movements between them.

*See *[*Connectors*](https://www.lightningdesignsystem.com/2e1ef8501/p/14914c)* for more information*
...
*See *[*Drag and Drop*](https://www.lightningdesignsystem.com/2e1ef8501/p/98fa99)* for more information*
...
*See *[*Click to Create*](https://www.lightningdesignsystem.com/2e1ef8501/p/437535)* for more information*
...
*See *[*Zoom Controls*](https://www.lightningdesignsystem.com/2e1ef8501/p/3447c3)* for more information*
...
Components are content building blocks. On the canvas, they provide a WYSIWYG representation of a configuration. For example, an image component displays a selected image on the canvas at the correct size, while a rich text component displays accurately formatted and styled text. Until they are configured, components in the [drop zone container](https://v1.lightningdesignsystem.com/components/drop-zone/#site-main-content) display a default state.
...
*See *[*Layout*](https://zeroheight.com/2e1ef8501/p/53eb31)* for more information*
...
*See *[*Drag and Drop*](https://zeroheight.com/2e1ef8501/p/98fa99)* for more information*
...
*See *[*Click to Create*](https://zeroheight.com/2e1ef8501/p/437535)* for more information*
...
*See *[*Layout*](https://www.lightningdesignsystem.com/2e1ef8501/p/53eb31)* for more information*
