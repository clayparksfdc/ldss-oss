...
category: "foundation"
url: "https://www.lightningdesignsystem.com/2e1ef8501/p/1234e1-tree-grid/b/451e1e"
extractedAt: "2026-02-21T21:56:40.419Z"
---
...
**Row Divider**: A horizontal line separating rows for better visual distinction.Header Row (optional): The top row that displays column titles and provides context for the data below.
...
Light[View in Storybook](https://sds-site-docs-1fea39e7763a.herokuapp.com/index.html?path=/story/components-tree-grid--base-expanded)

Row SelectionUsers can select one or more rows via checkboxes for bulk actions like delete or export. Selecting parent nodes does not select the associated child nodes.

Light[View in Storybook](https://sds-site-docs-1fea39e7763a.herokuapp.com/index.html?path=/story/components-tree-grid--base-selected-row)
