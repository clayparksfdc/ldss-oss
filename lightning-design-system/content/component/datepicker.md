...
```storybook
url: https://sds-site-docs-1fea39e7763a.herokuapp.com/iframe.html?id=components-datepicker--base
...
Margins and padding must be set according to your [form's](/component/form-element) layout. Give the datepicker enough space from other form elements to make the form easier to read.
