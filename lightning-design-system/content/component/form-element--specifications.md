...
Restrict
.slds-input-has-icon svg, .slds-input-has-icon button, .slds-input-has-icon span
...
Restrict
.slds-form-element span, .slds-form-element div
...
Restrict
.slds-form-element legend, .slds-form-element span
