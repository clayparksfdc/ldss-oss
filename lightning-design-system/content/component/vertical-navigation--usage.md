---
title: "Vertical Navigation - Usage"
...
```storybook
url: https://sds-site-docs-1fea39e7763a.herokuapp.com/iframe.html?id=components-vertical-navigation--basic
title: Vertical Navigation - Basic
height: 400px
```
...
- May be made filterable by appending the vertical nav to an input using [the Quickfind](/component/combobox).
