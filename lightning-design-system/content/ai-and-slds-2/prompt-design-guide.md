...
As tools like Agentforce and Einstein power more of your workflows, clear prompts are critical. They don’t just improve results—they make your AI more [sustainable](https://www.salesforce.com/content/dam/web/en_us/www/documents/reports/salesforce-ai-sustainability-outlook.pdf), too.
...
A broader, multi-step goal

Example: resolve a customer issue

**Interaction**

One-way instruction for a single action

Conversational multi-turn dialogues

**Capability**

Executes pre-defined text instructions

Orchestrates multiple tools and actions

**Intelligence**

Contained within the quality of the prompt

Understands intent, makes decisions, and takes action
