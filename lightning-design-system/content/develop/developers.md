...
SLDS gives you a great deal of control over the look and feel of your components with three supported customization layers. With each layer of customization, you have more control over a component’s individual elements, but the implementation becomes much more complex and granular. Always use the first layer of customization that works with your use case, and only use the next layer if your use case requires a more complex solution. 1. Use Lightning Base ComponentsWith Lightning Base Components, you can customize and style each Lightning Base Component with their built-in HTML attributes. Using these components is the best way to ensure accessibility and SLDS best practices. 2. Use SLDS Styling HooksIf you can’t meet your use-case by customizing the blueprint with SLDS classes, then you can use the foundational layer of customization in SLDS, Styling Hooks. Styling hooks are variables that provide CSS properties such as colors, typography, spacing, sizing, and more. If you decide to customize styling hooks for your org, closely follow the Global Styling Hook Guidance to make sure your customizations adhere to accessibility standards and SLDS best practices.
...
ComponentsBuild UIs with Lightning components.Styling hooksUse our web-standard CSS variables to style your apps.Developer ToolsExplore our custom tools to help enhance your Lightning development process.Hit the TrailTake the SLDS 2 for Developers module.
