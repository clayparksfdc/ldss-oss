...
| Validation alerts users to invalid components and offers possible solutions.  If a builder allows saves with invalid components, the validation alert is called a **warning**.  If a builder only allows saves using valid components, the validation alert is called an **error**. | Start using our Design Kits                          [           *         ](https://www.figma.com/@salesforce)                       *  *           *   [Open in Figma](https://www.figma.com/community/file/1415890669347272207) |
| --- | --- |
