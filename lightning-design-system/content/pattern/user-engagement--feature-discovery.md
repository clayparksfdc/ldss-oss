...
| *                     Use a feature popover to bring attention to new features and capabilities.           *  | *                     Walkthroughs are effective in pulling users through a series of steps across one or more new feature screens.           *  |
| --- | --- |
|  |  |
...
| *                     A feature popover can raise awareness of a feature a user may be overlooking.           *  | *                     The prompt popover is an effective, non-intrusive way to nudge users about a feature or capability.           *  |
| --- | --- |
|  |  |
