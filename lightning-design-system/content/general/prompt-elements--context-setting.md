...
category: "general"
url: "https://www.lightningdesignsystem.com/2e1ef8501/p/59dd9a-prompt-elements/b/95fe5f"
extractedAt: "2026-02-21T21:35:53.835Z"
---
...
...without any [excluded content]Sub-Element
...
a list of action items formatted in HTMLPatterns
...
Your task is to extract information about customer impressions, call summary, and next steps from a call transcript.Patterns
...
Use the Five Whys technique to dig beneath your surface level task and uncover the fundamental motivation. It’s a simple yet powerful way to understand the end goal of a task and how it affects the end user. Start with the key task and repeatedly ask why up to five times to drill down to the core goal and desired outcome.
...
The output will be used to determine the next stage.Pattern
...
You prioritize `[style]` and `[style]` communication.Sub-Element
...
…for the external API that expects a stringPatterns
...
The [output] will populate the [field name] field in a [object] recordTypes
...
You’re tasked with [action] after [preceding event].Types
...
...which can be earlier than `[date]`...Types
