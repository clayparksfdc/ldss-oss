...
A slider that allows users to select a value by moving a handle left or right along a horizontal track.
  ...
  UUID: b1346378-d6c0-4189-867b-bc885cf13ef6
 -->
...
A slider that allows users to select a value by moving a handle up or down along a vertical track.
  ...
  UUID: 339d78b4-8973-481a-b212-9c83d9a3594f
 -->### Horizontal (default)
...
**Supporting Text:** The error text appears below the slider to indicate validation issues and guide users on how to correct them.Field Label: The field label describes the purpose of the slider, helping users understand what value they are adjusting.
