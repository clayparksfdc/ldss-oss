...
category: "general"
url: "https://www.lightningdesignsystem.com/2e1ef8501/p/13cc12-breadcrumbs/b/39205c"
extractedAt: "2026-02-21T21:44:31.707Z"
---
...
**Use Case:** When users need to see their path and quickly return to previous categories.
  ...
  UUID: e1e2104a-6b4f-43c3-9382-7b378a673233
 -->
...
**Use Case:** Use to show only the most relevant levels. Hiding levels prevents clutter while offering an easy way to navigate back to the parent topic.
  ...
  UUID: 0bdc0d63-2987-45e2-a46f-eba88d524813
 -->

  

*Overflow breadcrumb example.*### Default Breadcrumb
...
**Breadcrumbs**: Each navigation node is composed of an individual breadcrumb that is combined to create breadcrumbs.Menu: Use the overflow button icon to condense the breadcrumb trail. When the button is clicked, a dropdown menu opens a list of the hidden breadcrumb links to select.
