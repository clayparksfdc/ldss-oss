...
SLDS 1 blueprint examples for **Split View**.
  ...
  <article hidden="" id="split-view-id" class="slds-split-view slds-grid slds-grid_vertical slds-grow">
      ...
      <div class="slds-grid slds-grid_vertical-align-center">
        ...
        <div class="slds-no-flex slds-grid slds-col_bump-left">
          <div class="slds-button-group">
            <button class="slds-button slds-button_icon slds-button_icon slds-button_icon-container-more" aria-haspopup="true" aria-expanded="false" title="Display As Split View">
              <svg class="slds-button__icon" aria-hidden="true">
    ...
    <div class="slds-grid slds-grid_vertical">
      ...
      <ul aria-multiselectable="true" class="slds-scrollable_y" role="listbox" aria-label="Select an item to open it in a new workspace tab.">
        ...
        <li class="slds-split-view__list-item" role="presentation">
          <a href="#" role="option" class="slds-split-view__list-item-action slds-grow slds-has-flexi-truncate" tabindex="-1">
            <div class="slds-grid slds-wrap">
  ...
  <article hidden="" id="split-view-id" class="slds-split-view slds-grid slds-grid_vertical slds-grow">
    ...
    <div class="slds-grid slds-grid_vertical">
      ...
      <ul aria-multiselectable="true" class="slds-scrollable_y" role="listbox" aria-label="Select an item to open it in a new workspace tab.">
        ...
        <li class="slds-split-view__list-item" role="presentation">
          <a href="#" aria-current="page" role="option" class="slds-split-view__list-item-action slds-grow slds-has-flexi-truncate" tabindex="-1">
            <div class="slds-grid slds-wrap">
              <span class="slds-truncate slds-text-body_regular slds-text-color_default" title="Riley Shultz">Riley Shultz</span>
              <span class="slds-truncate slds-col_bump-left" title="74">74</span>
            </div>
