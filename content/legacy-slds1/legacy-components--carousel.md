...
SLDS 1 blueprint examples for **Carousel**.
...
<div class="slds-carousel">
  <div class="slds-carousel__stage">
    ...
    <ul class="slds-carousel__indicators" role="tablist">
      ...
      <li class="slds-carousel__indicator" role="presentation">
        <a id="indicator-id-71" class="slds-carousel__indicator-action" href="#" role="tab" tabindex="-1" aria-selected="false" aria-controls="content-id-68" title="Click to Customize tab">
          <span class="slds-assistive-text">Click to Customize tab</span>
        </a>
      </li>
      <li class="slds-carousel__indicator" role="presentation">
        <a id="indicator-id-72" class="slds-carousel__indicator-action" href="#" role="tab" tabindex="-1" aria-selected="false" aria-controls="content-id-69" title="Download SalesforceA tab">
...
::: legacy-component-example title="Panel 1 active"
<div class="slds-carousel">
  <div class="slds-carousel__stage">
    <span class="slds-carousel__autoplay">
      <button class="slds-button slds-button_icon slds-button_icon-border-filled slds-button_icon-x-small" aria-pressed="false" title="Stop auto-play">
    ...
    <ul class="slds-carousel__indicators" role="tablist">
      ...
      <li class="slds-carousel__indicator" role="presentation">
        <a id="indicator-id-83" class="slds-carousel__indicator-action" href="#" role="tab" tabindex="-1" aria-selected="false" aria-controls="content-id-80" title="Click to Customize tab">
          <span class="slds-assistive-text">Click to Customize tab</span>
        </a>
      </li>
      <li class="slds-carousel__indicator" role="presentation">
        <a id="indicator-id-84" class="slds-carousel__indicator-action" href="#" role="tab" tabindex="-1" aria-selected="false" aria-controls="content-id-81" title="Download SalesforceA tab">
          <span class="slds-assistive-text">Download SalesforceA tab</span>
        </a>
      </li>
    </ul>
...
::: legacy-component-example title="Panel 2 active"
<div class="slds-carousel">
  <div class="slds-carousel__stage">
    <span class="slds-carousel__autoplay">
      <button class="slds-button slds-button_icon slds-button_icon-border-filled slds-button_icon-x-small" aria-pressed="false" title="Stop auto-play">
    ...
    <ul class="slds-carousel__indicators" role="tablist">
      ...
      <li class="slds-carousel__indicator" role="presentation">
        <a id="indicator-id-95" class="slds-carousel__indicator-action slds-is-active" href="#" role="tab" tabindex="0" aria-selected="true" aria-controls="content-id-92" title="Click to Customize tab">
          <span class="slds-assistive-text">Click to Customize tab</span>
        </a>
      </li>
      <li class="slds-carousel__indicator" role="presentation">
        <a id="indicator-id-96" class="slds-carousel__indicator-action" href="#" role="tab" tabindex="-1" aria-selected="false" aria-controls="content-id-93" title="Download SalesforceA tab">
          <span class="slds-assistive-text">Download SalesforceA tab</span>
        </a>
      </li>
    </ul>
