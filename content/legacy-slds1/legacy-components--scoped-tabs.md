...
SLDS 1 blueprint examples for **Scoped Tabs**.
...
::: legacy-component-example title="Selecting Tabs"
<div class="slds-tabs_scoped">
  <ul class="slds-tabs_scoped__nav" role="tablist">
    ...
    <li class="slds-tabs_scoped__item slds-is-active" title="Item Two" role="presentation">
      <a class="slds-tabs_scoped__link" href="#" role="tab" tabindex="0" aria-selected="true" aria-controls="tab-scoped-2" id="tab-scoped-2__item">Item Two</a>
    </li>
    <li class="slds-tabs_scoped__item" title="Item Three" role="presentation">
      <a class="slds-tabs_scoped__link" href="#" role="tab" tabindex="-1" aria-selected="false" aria-controls="tab-scoped-3" id="tab-scoped-3__item">Item Three</a>
    </li>
...
::: legacy-component-example title="With Overflowing Items"
            ...
            <ul class="slds-dropdown__list slds-dropdown_length-with-icon-10" role="menu">
              <li class="slds-dropdown__item" role="presentation">
                <a href="#" role="menuitem" tabindex="-1">
                  <span title="Item Four">Item Four</span>
                </a>
              </li>
              <li class="slds-dropdown__item" role="presentation">
                <a href="#" role="menuitem" tabindex="-1">
                  <span title="Item Five">Item Five</span>
                </a>
              </li>
              <li class="slds-dropdown__item" role="presentation">
                <a href="#" role="menuitem" tabindex="-1">
                  <span title="Item Six">Item Six</span>
                </a>
              </li>
            </ul>
          </div>
