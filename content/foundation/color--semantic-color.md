...
[Styling hooks](/develop/global-styling-hooks) manage visual styles. In Figma, styling hooks appear as variables and are applied through style properties. In code, styling hooks are expressed as CSS variables. We organize and name styling hooks so you can quickly understand where and how to use them.
