...
Variant
trueSelector
.slds-color-picker_predefined-only
...
Restrict
.slds-color-picker__selector divSelector
...
Restrict
.slds-color-picker__custom > divSelector
.slds-swatch
...
Restrict
.slds-color-picker__swatch span, .slds-color-picker__summary-button span, .slds-color-picker__hue-and-preview spanSelector
...
Restrict
.slds-color-picker__hue-and-preview inputSelector
...
Restrict
.slds-color-picker__custom-range > aSelector
...
Restrict
.slds-color-picker__swatches liSelector
...
Restrict
.slds-color-picker__selector ulSelector
...
Restrict
.slds-color-picker div, .slds-color-picker sectionSelector
...
Restrict
.slds-color-picker__summary divSelector
...
Restrict
.slds-color-picker__summary .slds-buttonSelector
...
Restrict
.slds-color-picker__summary > labelSelector
