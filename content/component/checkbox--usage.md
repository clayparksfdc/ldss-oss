...
```storybook
url: https://sds-site-docs-1fea39e7763a.herokuapp.com/iframe.html?id=components-checkbox--base&globals=theme%3Alight
title: Checkbox - Base
height: 400px
```
...
| --- | --- |
| *                       *  *           *  | **Label:**Text description that defines the option.   Checkboxes can be used without a label in datatables to select the row. |
