...
```storybook
url: https://sds-site-docs-1fea39e7763a.herokuapp.com/iframe.html?id=components-progress-bar--base
...
- Don’t use the Progress Bar if your process requires user input or decisions at each step. Use a [Progress Indicator](/component/progress-indicator) instead.
