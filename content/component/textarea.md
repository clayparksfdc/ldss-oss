...
```storybook
url: https://sds-site-docs-1fea39e7763a.herokuapp.com/iframe.html?id=components-textarea--base&globals=theme%3Alight
title: Textarea - Base
height: 400px
```
...
- Use textarea components with the [form element](/component/form-element) component to ensure sufficient spacing between multiple input fields.
