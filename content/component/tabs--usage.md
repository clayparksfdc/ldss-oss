...
```storybook
url: https://sds-site-docs-1fea39e7763a.herokuapp.com/iframe.html?id=components-tabs--base
title: Tabs - Base
height: 400px
```
...
Base tabs can be set to default, medium, and large sizes using the [SLDS utility classes](/develop/utility-classes) to accommodate different layouts, user needs, and content requirements.
