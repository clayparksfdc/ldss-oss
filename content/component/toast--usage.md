...
```storybook
url: https://sds-site-docs-1fea39e7763a.herokuapp.com/iframe.html?id=components-toast--base
title: Toast - Base
height: 400px
```
...
- Choose to dismiss automatically after a set time, or require manual dismissal. See [dismissal behaviors](/component/toast).
