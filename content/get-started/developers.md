...
With [Lightning Base Components](/get-started/developers), you can customize and style each Lightning Base Component with their built-in HTML attributes. Using these components is the best way to ensure accessibility and SLDS best practices. 
