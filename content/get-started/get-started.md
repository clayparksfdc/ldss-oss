...
:::card-grid{columns="3"}
::card{title="Admins" href="/get-started/admins" description="Adopt Salesforce Cosmos to get the new design and SLDS 2 features."}
::card{title="Designers" href="/get-started/designers" description="Connect to essential components and tools to create great experiences."}
::card{title="Developers" href="/get-started/developers" description="Access the framework for building consistent and scalable interfaces."}

::card{title="Transition to SLDS 2" href="/get-started/transition-to-slds-2" description="Get step-by-step instructions for making the move to SLDS 2."}
::card{title="Resources" href="/get-started/resources" description="Learn more about SLDS 2 and Salesforce Cosmos."}
:::
