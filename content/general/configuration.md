...
[Open in Figma](https://www.figma.com/community/file/1415890669347272207)When creating a new builder, start with a builder type, then make design choices that support its use case.
...
Fixed panel configuration with header, canvas, and left and right fixed panels
      ...
      Flexible panel configuration with header, canvas, rail, and floating panelFixed panel configuration with header, canvas, and left and right fixed panels
