...
Restrict
.slds-rich-text-editor divSelector
.slds-has-error
...
Restrict
.slds-rich-text-editor__select .slds-combobox__form-elementSelector
...
Restrict
.slds-rich-text-editor__toolbar divSelector
.slds-rich-text-editor__toolbar-bottom


Restrict
.slds-rich-text-editor__toolbarSelector
...
Restrict
.slds-rich-text-editor_toolbar-only .slds-rich-text-editor__toolbarSelector
.slds-rich-text-editor_toolbar-only


Restrict
.slds-rich-text-editorSelector
.slds-rich-text-editor
