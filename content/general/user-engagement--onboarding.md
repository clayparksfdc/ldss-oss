...
| *                       *  Trial bar with welcome mat welcoming new users to your product.  *           * ** ** ** | *                       *  Trial bar with series of walkthroughs showing users your product's value propositions.  *           * ** ** ** |
| --- | --- |
|  |  |
| *                     Simple welcome mat introducing users to your product.           * ** ** ** | *                     Docked assistant supporting users as they explore and navigate your product.           * ** ** ** |
|  |  |
| *                     Achievements for exploring and adopting features.           * ** ** ** | *                     Empty states to encourage action and invite users to get to know your product.           * ** ** ** |
...
| *                     Persistent and contextual setup assistant card.           * ** ** ** | *                     Docked assistant with setup checklist that can be docked and completed as a user explores.           * ** ** ** |
| --- | --- |
|  |  |
...
| *                     Simple welcome mat announcing a new release, with a call to action to learn more and explore new features.           * ** ** ** | *                     Featured video in a welcome mat, highlighting and demonstrating new features.           * ** ** ** |
| --- | --- |
|  |  |
| *                     Persistent and contextual setup assistant card, to help a user or admin use and set up new features.           * ** ** ** | *                     Docked assistant with setup checklist, which can be docked and completed as user explores.           * ** ** ** |
