---
title: "Tooltip"
description: "Tooltips appear on hover and disappear when the cursor moves away."
category: "component"
...
- When using a link as the focusable element to show a tooltip, add a `` at the bottom of the tooltip bubble that includes a description of where the link will take the user. Add `aria-hidden='true'` to this element, and ensure that the link text itself matches the text within this ``.
