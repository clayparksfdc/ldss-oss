---
title: "Spinners"
description: "Spinners do not require direct interaction via mouse."
category: "component"
...
- Use ARIA attributes where relevant:<ul><li>Set `aria-live="polite"` or `aria-live="assertive"` so screen readers notify users of the loading state.</li><li>Apply `role="status"` when applicable.</li></ul>
