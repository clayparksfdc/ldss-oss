---
title: "Form Element"
description: "We understand the importance of a keyboard operation that enhances the experience for blind users and others who rely on keyboard navigation. Lightning also integrates numerous other accessibility con"
category: "component"
...
Activate buttons or toggle elements (e.g., checkboxes).

**Arrow Keys**

Navigate between options in dropdowns, radio buttons, or multi-option elements.

**Escape**

Close open dropdowns or dialogs without making a selection.
...
- Validation Feedback:<ul><li>Validation errors should be announced to screen readers.</li><li>Use clear and positive phrasing for error messages.</li></ul>
- Validation errors should be announced to screen readers.
- Use clear and positive phrasing for error messages.
- Help Text:<ul><li>Use tooltips or supporting text to provide additional guidance without cluttering the UI.</li><li>Ensure helptext tooltips are accessible via keyboard and screen readers.</li></ul>
...
- All form elements marked as required with an * must have an accompanying legend.**Example:** * denotes a required field
