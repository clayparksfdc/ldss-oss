---
title: "Datepicker"
description: "When using a mouse, the Datepicker component allows users to:"
category: "component"
...
Navigate through months or years

Tab to year picklist, Enter or Spacebar to open year picklist, and arrow keys (up, down) and enter to select.
...
- All datepicker fields marked as required with an * must have an accompanying legend.**Example:** * denotes a required field
