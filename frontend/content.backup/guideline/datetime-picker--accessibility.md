...
Click Actions: Users can click on the input field to open the calendar and time dropdowns, allowing them to select a date and time easily. Clicking the calendar icon opens the calendar widget, which follows the Datepicker Accessibility guidance.
