...
slug: "icons"
category: "foundation"
url: "https://www.lightningdesignsystem.com/2e1ef8501/p/83309d-icons"
extractedAt: "2026-02-21T18:12:23.594Z"
---
...
Icons are symbols used to represent features, functionality, or content. Visit the icon page to see a library of all icons and the icon component for implementation details.
...
Get IconsDownload the SLDS Icons zip folder with both svg and png file types.Icons for FigmaAccess the SLDS icons in the Figma UI Kit.Browse Icons Browse the SLDS icon library
...
Object Icons (Standard and Custom)Example: Account
...
Product IconsExample: Sales Cloud
...
For more information on icon accessibility, see the Icon component.
...
Icons are based on an 8pt grid system and come in four keyline shapes—circle, square, vertical rectangle, and horizontal rectangle. These shapes are created using business process model and notation (BPMN) diagram conventions.
