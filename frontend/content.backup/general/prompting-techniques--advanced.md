...
description: "These methods leverage more sophisticated strategies, often involving external information or iterative model interactions, to achieve complex goals."
category: "general"
...
| Prompt 3Create Detailed Proposal | Using the solution overview, create a detailed sales proposal, including specific features, benefits, and pricing. | [Solution Overview] (from Prompt 2) | [Sales Proposal] |   |
