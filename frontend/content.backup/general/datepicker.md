...
**Use Case: **Ideal for picking a single date.
  ...
  UUID: 51044a9c-da5c-403d-a1c7-e9b63001557b
 -->
...
**Use Case: **Useful for situations that require the selection of a start and end date, such as scheduling events or tasks.
  ...
  UUID: 7c687b5e-dd96-4724-89b2-bf113600d004
 -->

  

*Date range picker in the default state.*### Standard Datepicker
...
**End Date Input Field:** May include today’s date.Input Field: Where the date is displayed and can be edited directly or through the calendar view.
...
Margins and padding must be set according to your form's layout. Give the datepicker enough space from other form elements to make the form easier to read.
...
**Triggers**Clicking the input field triggers the calendar to open.
  ...
  UUID: ce760d32-a3f6-4329-bacc-c503df544b31
 -->

  

*Calendar opened.*#### Triggers
